...
import com.coupon.cpms.exception.AttachFileException;
...
public class FileUtils {
	 ...
	 * @return 업로드 파일 목록
	 */
	public List<AttachDTO> uploadFiles(MultipartFile[] files, Long bbsUno) {
